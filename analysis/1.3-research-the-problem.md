...
As with Math Rescue, platforming is also an integral part of the game, despite the game being marketed as educational. In Donkey Kong Jr. Math, you must climb vines to get to the numbers, where you can select them to solve a maths question. An example of such is where you are given a number, and you must use the numbers and operation signs to get to that number (e.g. for 18, get a 3, the x symbol and a 6). You can also compete against another player with the same question (_www.youtube.com, n.d._). This could be a fun way to learn maths, as it combines the educational content with platforming skills.
